  ...
  guardarPropietario() {
    if(this.p_tdi_numero.length < 6){
      ...
      let dataPost = {
        ...
        p_prp_apepat:this.p_rec_apepat.toUpperCase(),
        p_prp_apemat:this.p_rec_apemat.toUpperCase(),
        p_prp_nombre:this.p_rec_nombre.toUpperCase(),
        ...
        p_prp_direcc:this.p_rec_direcc.toUpperCase(),
